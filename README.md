...
- **Projects and tasks:** Organise work into projects, tasks, and subtasks with owners, priorities, and due dates.
...
- **Projects and tasks:** Create projects with name, descriptions, and tasks with descriptions, an assignee, priority, due date, and status.
